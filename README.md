...
総額専用の切替で「直近比」「7日前」「30日前」「3か月前」を選べます。
- 直近比：各カードの相場日（source_date）順で、最新のひとつ前の価格。
- 7日前・30日前：閲覧時の日本時間の今日から7日・30日前を共通の基準日とします。
- 3か月前：日本時間の今日から暦で3か月前。同じ日がなければその月の末日（例：5月31日 → 2月28日、うるう年は29日）。
- 日付指定の比較は基準日ちょうどの価格を優先し、なければその日以前でもっとも近い相場日の価格を使用します。基準日より後の価格で代用しません。基準日は画面にも表示します。
